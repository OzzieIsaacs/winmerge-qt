...
#include "ui_QPropMarkerColors.h"
 ...
 */
void QPropMarkerColors::ReadOptions()
{
 ...
 */
void QPropMarkerColors::WriteOptions()
{
 ...
 */
/*void QPropMarkerColors::BrowseColorAndSave(CColorButton & colorButton, int colorIndex)
{
 ...
 */
/*void QPropMarkerColors::OnMarkerColors(UINT nID)
{
 ...
 */
/*void QPropMarkerColors::SerializeColorsToFromScreen(OPERATION op)
{
	if (op == SET_DEFAULTS)
 ...
 * (No save operation because BrowseColorAndSave saves immediately when user chooses)
 */
/*void QPropMarkerColors::SerializeColorToFromScreen(OPERATION op, CColorButton & btn, int colorIndex)
{
	switch (op)
	{
		case SET_DEFAULTS:
