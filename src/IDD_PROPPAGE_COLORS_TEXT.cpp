...
#include "ui_IDD_PROPPAGE_COLORS_TEXT.h"
...
IDD_PROPPAGE_COLORS_TEXT::IDD_PROPPAGE_COLORS_TEXT(QWidget *parent) :
	QDialog(parent),
	ui(new Ui::IDD_PROPPAGE_COLORS_TEXT)
{
	ui->setupUi(this);
}
IDD_PROPPAGE_COLORS_TEXT::~IDD_PROPPAGE_COLORS_TEXT()
{
	delete ui;
}

void IDD_PROPPAGE_COLORS_TEXT::ReadOptions()
{
	// ToDo: port
 ...
 */
void IDD_PROPPAGE_COLORS_TEXT::WriteOptions()
{
	// ToDo: port
 ...
 */
/*void IDD_PROPPAGE_COLORS_TEXT::BrowseColorAndSave(CColorButton & colorButton, int colorIndex)
{
	// ToDo: port
 ...
 */
void IDD_PROPPAGE_COLORS_TEXT::OnWhitespaceBackgroundColor()
{
 ...
 */
void IDD_PROPPAGE_COLORS_TEXT::OnRegularBackgroundColor()
{
 ...
 */
void IDD_PROPPAGE_COLORS_TEXT::OnRegularTextColor()
{
 ...
 */
void IDD_PROPPAGE_COLORS_TEXT::OnSelectionBackgroundColor()
{
 ...
 */
void IDD_PROPPAGE_COLORS_TEXT::OnSelectionTextColor()
{
 ...
 */
void IDD_PROPPAGE_COLORS_TEXT::OnMarginBackgroundColor()
{
 ...
 */
void IDD_PROPPAGE_COLORS_TEXT::SerializeColorsToFromScreen(OPERATION op)
{
	// ToDo: Port easy
	/*
	if (op == SET_DEFAULTS)
 ...
 */
void IDD_PROPPAGE_COLORS_TEXT::OnDefaultsStandardColors()
{
 ...
 */
void IDD_PROPPAGE_COLORS_TEXT::EnableColorButtons(bool bEnable)
{
	// Todo: port easy
	/*
