 ...
 */
void VariantValue::SetString(const char *sz)
{
	Clear();
	m_vtype = VT_STRING;
	if (sz != nullptr)
 ...
 */
void VariantValue::SetString(const QString& sz)
{
	m_svalue = sz;
	m_vtype = VT_STRING;
}
 ...
 * @return String value.
 */
const QString& VariantValue::GetString() const
{
